...
class HelplineAdapter extends RecyclerView.Adapter<HelplineAdapter.ViewHolder> {
    private static final int REQUEST_DIAL_FINISHED = 911;
    ...
    HelplineAdapter(Context context, Listener listener) {
        mContext = context;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(SensitivePhoneNumberInfo helpline) {
            String name = HelplineUtils.getName(mResources, helpline);
            ...
            String categories = HelplineUtils.getCategories(mResources, helpline);
