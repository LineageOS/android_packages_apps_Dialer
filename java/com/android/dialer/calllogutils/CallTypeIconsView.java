...
public class CallTypeIconsView extends View {
    ...
    public CallTypeIconsView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.CallTypeIconsView, 0, 0);
    ...
    private static class Resources {
        ...
        /**
         * Configures the call icon drawables. A single white call arrow which points down and left
         * is used as a basis for all of the call arrow icons, applying rotation and colors as
         * needed.
         *
         * <p>For each drawable we call mutate so that a new instance of the drawable is created.
         * This is done so that when we apply a color filter to the drawables, they are recolored
         * across dialer.
         *
        ...
        private Drawable getScaledBitmap(Context context, int resourceId) {
            ...
            int scaledHeight = context.getResources()
                    .getDimensionPixelSize(R.dimen.call_type_icon_size);
