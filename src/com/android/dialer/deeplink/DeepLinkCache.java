...
public class DeepLinkCache {
    ...
    private static int DONT_OVERLOAD_FUCKING_AMBIENT = 200;
        ...
        public void run() {
            while (true) {
                ...
                synchronized (mRequests) {
                    if (!mRequests.isEmpty() && pendingSize < DONT_OVERLOAD_FUCKING_AMBIENT) {
                ...
                } else if (mPendingRequests.size() < DONT_OVERLOAD_FUCKING_AMBIENT){
