...
public class DeepLinkIntegrationManager {
    ...
    /**
     * Verifies the client is connected.
    ...
    public void isApplicationTypeEnabled(DeepLinkApplicationType deepLinkApplicationType,
        ...
        if (hasConnectedClient() && callback != null) {
            String cbString = callback.toString();
            completeEnabledRequest(cbString);
     ...
     *
     * @param cbString string result of toString() called on a ResultCallback<T> of any type.
     */
    public void completeEnabledRequest(String cbString) {
    ...
    /**
     * Cancel all pending, uncompleted requests.
     */
