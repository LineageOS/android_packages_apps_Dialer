...
public class JapaneseSmartDialMap implements SmartDialMap {
    ...
    private static final char[] JAPANESE_LETTERS_TO_DIGITS = {
        '0', '0',                // わ,を -> 0
        '1', '1', '1', '1', '1', // あ,い,う,え,お -> 1
        '2', '2', '2', '2', '2', // か,き,く,け,こ -> 2
        '3', '3', '3', '3', '3', // さ,し,す,せ,そ -> 3
        '4', '4', '4', '4', '4', // た,ち,つ,て,と -> 4
        '5', '5', '5', '5', '5', // な,に,ぬ,ね,の -> 5
        '6', '6', '6', '6', '6', // は,ひ,ふ,へ,ほ -> 6
        '7', '7', '7', '7', '7', // ま,み,む,め,も -> 7
        '8', '8', '8',           // や,ゆ,よ -> 8
        '9', '9', '9', '9', '9'  // ら,り,る,れ,ろ -> 9
    };

    @Override
    public boolean isValidDialpadAlphabeticChar(char ch) {
        return (ch >= 'a' && ch <= 'z') || (ch >= 'わ' && ch <= 'ろ');
    }
    ...
    public byte getDialpadIndex(char ch) {
        if (ch >= '0' && ch <= '9') {
            ...
            return (byte) (JAPANESE_LETTERS_TO_DIGITS[ch - 'わ'] - '0');
        } else {
            return -1;
        }
    }
    ...
    public char getDialpadNumericCharacter(char ch) {
        ...
        if (ch >= 'わ' && ch <= 'ろ') {
            return JAPANESE_LETTERS_TO_DIGITS[ch - 'わ'];
        }
        return ch;
    }
