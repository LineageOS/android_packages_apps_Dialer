...
public class HanziToPinyin {
    ...
    // Engle, 从深度OS中合并多音字,
    // https://github.com/ShenduOS/android_packages_providers_ContactsProvider/blob/jellybean/src/com/android/providers/contacts/HanziToPinyin.java
    public static final String[] MULTINAMES = {
        "\u590f","\u77bf","\u66fe","\u77f3","\u89e3","\u85cf","\u7fdf","\u90fd",
        "\u516d","\u8584","\u8d3e","\u5c45","\u67e5","\u76db","\u5854","\u548c",
        "\u84dd","\u6bb7","\u4e7e","\u9646","\u4e5c","\u961a","\u53f6","\u5f3a",
        "\u6c64","\u4e07","\u6c88","\u4ec7","\u5357","\u5355","\u535c","\u9e1f",
    ...
    public static final byte[][] MULTIPYS = {
     ...
     */
    private static String getMPinyin(String firstname) {
        int offset, cmp;
        cmp = -1;
    ...
    // Engle, 从深度OS中合并多音字
    private Token getToken(char character, boolean fn) {
//    private Token getToken(char character) {
        ...
        // Engle, 从深度OS中合并多音字, 开始
        if (fn == true) {
            token.target = getMPinyin(letter);
            if (token.target != null)
                return token;
        }
        // Engle, 从深度OS中合并多音字, 结束
        ...
        for (int i = 0; i < inputLength; i++) {
            ...
            if (character == ' ') {
                ...
                if (i == 0)
                    ...
                    firstname = false;
                Token t = getToken(character, firstname);
