    ...
    public static PhoneNumberTokens parsePhoneNumber(String number) {
        ...
        if (!TextUtils.isEmpty(number)) {
            ...
            if (number.charAt(0) == '+') {
                 ...
                 */
                if ((normalizedNumber.length() == 11) && (normalizedNumber.charAt(0) == '1' || normalizedNumber.charAt(0) == '7') &&
                        (sUserInNanpRegion)) {
            ...
            if (sUserInNanpRegion)  {
                ...
                } else if ((countryCode.equals("1") || countryCode.equals("7")) && normalizedNumber.length() == 11) {
