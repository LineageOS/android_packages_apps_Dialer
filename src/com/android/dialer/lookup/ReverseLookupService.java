...
public class ReverseLookupService implements PhoneNumberService, Handler.Callback {
    ...
    public void getPhoneNumberInfo(String phoneNumber, NumberLookupListener numberListener,
        ...
        // For NANP, prepend the area code if the user didn't supply it (7 digits plus a hyphen == 8)
        if (phoneNumber.length() == 8 && SmartDialPrefix.isCountryNanp(countryIso))
            phoneNumber = "(" + mTelephonyManager.getLine1Number().substring(0,3) + ") " + phoneNumber;
