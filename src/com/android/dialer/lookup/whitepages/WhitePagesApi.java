...
public class WhitePagesApi {
    ...
    private static final String NEARBY_URL_LOCATION = "/search/ReversePhone?full_phone=";
    ...
    private static final String PROFILE_REGEX = "href=\"(.+?)\"";
    ...
    public static List<ContactInfo> peopleLookup(Context context, String filter)
        ...
        for (String entry : entries) {
            ...
            ContactInfo info = createContactInfoFromProfilePage(
                    LookupUtils.httpGet(profileUrl, null), profileUrl, null, filter);
            if (info != null) {
                infos.add(info);
            }
        }
    ...
    public static ContactInfo reverseLookup(Context context, String normalizedNumber,
        ...
        Uri uri = Uri.parse(urlPrefix)
            .buildUpon()
            .appendPath(NEARBY_URL_LOCATION)
            .appendQueryParameter("full_phone", normalizedNumber)
            .build();
        return createContactInfoFromProfilePage(LookupUtils.httpGet(uri.toString(), null),
