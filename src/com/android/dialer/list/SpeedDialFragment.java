...
public class SpeedDialFragment extends Fragment implements OnItemClickListener,
    ...
    public void onResume() {
        ...
        if (PermissionsUtil.hasContactsPermissions(getActivity())) {
            ...
            if(DialerDataSubscription.get(getContext())
                    .subscribe(AMBIENT_SUBSCRIPTION_ID, pluginsUpdatedReceiver)) {
                providersUpdated(DialerDataSubscription.get(getContext()).getPluginInfo());
                DialerDataSubscription.get(getContext()).refreshDynamicItems();
            }
