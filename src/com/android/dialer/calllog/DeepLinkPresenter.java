...
public class DeepLinkPresenter {
    ...
    private void updateViews() {
        if (mDeepLink != null && mDeepLink != DeepLinkRequest.EMPTY) {
            if (canUpdateImageIconViews()) {
                mViews.viewNotActionIcon.setImageDrawable(mDeepLink.getDrawableIcon(mContext));
            ...
            if (canUpdateImageIconViews()) {
                ...
                mViews.viewNotActionIcon.setImageDrawable(null);
            }
    ...
    private boolean canUpdateImageIconViews() {
        return mViews.viewNoteButton != null  && mViews.viewNotActionIcon != null;
    }
